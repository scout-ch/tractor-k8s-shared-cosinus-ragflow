...
function buildFrontmatter(
    section: { title: string; created_at: string; updated_at: string },
...
assert.ok(fm.includes('source_document: "thilo"'), 'source_document must be quoted');
assert.ok(fm.includes('source_url: "https://thilo.scouts.ch/auftrag"'), 'source_url must be quoted');
